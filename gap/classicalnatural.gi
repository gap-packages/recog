...
RECOG.Sp2n_UpStep := function(w)
  # w has components:
  #   d       : size of big Sp(2d,q)
  #   n       : size of small Sp(2n,q)
  #   slnstdf : fakegens for Sp(2n,q) standard generators
  #   bas     : current base change, first 2n vectors are where Sp(2n,q) acts
  #             rest of vecs are invariant under Sp(2n,q)
  #   basi    : current inverse of bas
  #   sp2d    : original group with memory generators, PseudoRandom
  #             delivers random elements
  #   sp2df   : fake generators to keep track of what we are doing
  #   f       : field
  # The following are filled in automatically if not already there:
  #   p       : characteristic
  #   ext     : q=p^ext
  ...
  #   slnstdf are SLPs to reach standard generators of SL_n from the
  #       generators of sld
  local DoColOp_n,DoRowOp_n,FixSLn,Fixc,MB,Vn,Vnc,aimdim,c,c1,c1f,cf,cfi,ci,cii,coeffs,flag,i,id,int1,int3,j,k,lambda,list,mat,newbas,newbasf,newbasfi,newbasi,newdim,newpart,perm,pivots,pivots2,pow,s,sf,slp,sum1,tf,trans,transd,transr,v,vals,zerovec;
