...
function(ri)
    ...
    if gensNWasEmpty then
        ...
        # a means to specify how many generators should be created. Thus, if we
        # set the factor below to 2, the kernel generation method gets called
        # twice
        targetNrGensN := Int(1.7 * Length(gensN(ri)));
    fi;
    Info(InfoRecog, 2,
