...
# multiplies some of the generators (goes through the list (of generators)
# and multiplies an entry with probability 1/2 to the Subproduct of the
# earlier entries)
...
# Computs randomly (so maybe not) the normal closure of list under
# the group generated by grpgens
