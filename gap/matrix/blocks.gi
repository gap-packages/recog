...
function(ri)
  local G,H,d,f,gens,hom,i,isscalars,j,newgens,upperleft;
...
"Hint TODO",
function(ri)
  local G,f,gcd,generator,gens,i,l,o,pows,q,rep,slp,subset,z;
...
#! Since it is known the image will be in block lower triangular form, a
#! hint is set to ensure that recognition on the image uses the method
...
function(ri)
  ...
  local G,H,bc,compseries,hom,newgens;
