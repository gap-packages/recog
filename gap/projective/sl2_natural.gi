...
#############################################################################
##
##  RECOG.ConRecogNaturalSL23
##
##  Strategy:
##    Since q = 3 is prime, SL(2,3) is generated by two transvections alone.
##    We directly search for upper and lower triangular transvections
##    via a random walk in the standard basis.
##
##  Note: A more efficient approach would be to find an element of order 3,
...
RECOG.ConRecogNaturalSL23 := function(G,f)
