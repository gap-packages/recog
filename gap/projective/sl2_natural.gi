...
## It integrates the function RECOG.RecogNaturalSL2 to produce 
## the same output format as RECOG.RecogniseSL2NaturalEvenChar
## and RECOG.RecogniseSL2NaturalOddCharUsingBSGS.
## G must be SL(2,q) generated by 2x2 matrices over GF(q).
...
#############################################################################
##
## G must be SL(2,2) generated by 2x2 matrices over GF(2).
## Returns a rec in the same format as RECOG.ConRecogNaturalSL2,
## containing standard generators t (lower transvection [[1,0],[1,1]])
## and s (upper transvection [[1,1],[0,1]]) together with base change
## matrices bas and basi.
##
...
#############################################################################
## G must be SL(2,5) generated by 2x2 matrices over GF(5).
## 
##
## Strategy:
