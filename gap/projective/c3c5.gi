...
#! semilinear reduction from [CNRD09, Section 6.4, Proposition 6.4 and
#! Theorem 6.5]. In the present situation the semilinear action has
#! trivial field automorphism part, so the whole group can be rewritten over
#! <M>GF(q^e)</M> in dimension <M>d/e</M>.
#!
#! The method returns only <K>Success</K> or <K>NeverApplicable</K>. The test
#! <C>RECOG.IsAbsolutelyIrreducible(ri)</C> determines and caches the status
#! in <C>ri!.isabsolutelyirred</C>; if it is <K>false</K> then this method
#! always succeeds.
#! @EndChunk
...
#!
#! This is the easy part of the <M>C_5</M> reduction from [CNRD09,
#! Section 6.3, Theorem 6.3], using the smallest-field base change
#! described earlier in the same paper / habilitation chapter.
#! @EndChunk
...
#! @BeginChunk C3C5
#! This method implements the main case distinction of [CNRD09,
#! Sections 6.3--6.7] for absolutely irreducible projective groups after the
#! immediate reducibility, subfield and non-absolute-irreducibility tests have
